...
if is_vision_available():
    ...
    from transformers import PointBERTImageProcessor


class PointBERTImageProcessingTester(unittest.TestCase):
    def __init__(
        self,
        parent,
        batch_size=7,
...
@require_torch
@require_vision
class PointBERTImageProcessingTest(ImageProcessingSavingTestMixin, unittest.TestCase):
    image_processing_class = PointBERTImageProcessor if is_vision_available() else None

    def setUp(self):
        self.image_processor_tester = PointBERTImageProcessingTester(self)
