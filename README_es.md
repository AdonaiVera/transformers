...
1. **[Point-BERT](https://huggingface.co/docs/transformers/main/model_doc/point-bert)** (from <FILL INSTITUTION>) released with the paper [<FILL PAPER TITLE>](<FILL ARKIV LINK>) by <FILL AUTHORS>. 
